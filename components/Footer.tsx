        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex gap-3">
              {bio.socials.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full flex items-center justify-center bg-[var(--bg-tertiary)] border border-white/5 text-[var(--text-secondary)] hover:text-white hover:border-[#6366f1]/50 hover:bg-[rgba(99,102,241,0.1)] transition-all duration-300"
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-[#818cf8] hover:text-[#6366f1] transition-colors"
            >
              {bio.email}
              <svg
                xmlns="http://www.w3.org/2000/svg"
